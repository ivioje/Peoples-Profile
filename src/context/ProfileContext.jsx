...
export const ProfileContextProvider = ({ children }) => {
    ...
    return (
        <ProfileContext.Provider value={{
            toggleEducationView, toggleOrganisationView, toggleWorkView, toggleGenderView, scrollToTop,
            setToggleEducationView, setToggleGenderView, setToggleOrganisationView, setToggleWorkView,
            handleFilterClick, handleToggleEduView, handleToggleGenderView, handleToggleWorkView, handleToggleOrgView,
            getSimilarItemsCount, filterData, nodeRef, handlePageNumber, paginatedItems, query, setQuery, data,
            removeFromFavorites, favorites, setFavorites, currentPage, containerRef
        }}>
            {children}
