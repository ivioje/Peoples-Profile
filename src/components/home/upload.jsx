...
const Upload = () => {
	return (
		<motion.div
			viewport={{ root: false }}
			className="flex justify-between items-center flex-col md:flex-row my-[45px] 
		...
		>
			...
			>
				...
				<p className="font-poppins font-[16px]  py-4">
					Upload your professional and non-professional profile for others to
					connect with you. Easily upload your employees profile. You can upload
					unlimited number of profiles.
				</p>
				<button
					className="btn font-firaSans primary-gradient text-dimWhite font-[500] text-[20px] 
