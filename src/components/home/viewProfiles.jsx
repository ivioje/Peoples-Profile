    ...
    return (
        <motion.section className='flex justify-between items-center md:flex-row-reverse flex-col
         my-[45px] md:my-[54px] md:px-[100px] px-4 w-full' viewport={{ root: false }}>
            <motion.div className='w-full md:w-[40%] px-3 md:pt-10 pt-5'
                initial={{ x: '20vw', opacity: 0 }} transition={{ type: 'spring', duration: 1, bounce: 0.3 }} whileInView={{ x: 0, opacity: 1 }} >
            ...
            <motion.div className='w-full flex justify-center md:justify-start md:w-[500px] md:my-0 my-10'
                initial={{ x: '20vw', opacity: 0 }} transition={{ type: 'spring', duration: 1, bounce: 0.3 }} whileInView={{ x: 0, opacity: 1 }} >
